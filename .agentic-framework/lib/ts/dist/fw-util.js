...
function dateFmt(args) {
  ...
  switch (flag) {
    case "--iso":
      ...
      break;
    case "--epoch":
      process.stdout.write(Math.floor(now.getTime() / 1e3) + "\n");
      break;
    case "--human":
