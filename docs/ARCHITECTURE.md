...
| termlink-mcp | 56 | MCP integration tests (33 tools, resources, prompts, event_subscribe, dispatch_status, info, topics, collect, pty_mode, hub_status) |
...
| **Total** | **697** | + 4 interactive TTY tests (ignored in CI) |
