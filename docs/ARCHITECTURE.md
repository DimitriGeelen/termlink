...
| termlink-mcp | 54 | MCP integration tests (32 tools, resources, prompts, event_subscribe, dispatch_status, info, topics, collect, pty_mode) |
...
| **Total** | **695** | + 4 interactive TTY tests (ignored in CI) |
