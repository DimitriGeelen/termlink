...
| termlink-mcp | 59 | MCP integration tests (34 tools, resources, prompts, event_subscribe, dispatch_status, info, topics, collect, pty_mode, hub_status, file_send) |
...
| **Total** | **700** | + 4 interactive TTY tests (ignored in CI) |
