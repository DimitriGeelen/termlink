...
| termlink-mcp | 51 | MCP integration tests (30 tools, resources, prompts, event_subscribe, dispatch_status, info, topics) |
...
| **Total** | **692** | + 4 interactive TTY tests (ignored in CI) |
