...
description: >
  S-28/C-39: canary logs carry entries with no per-entry ISO dates and some logs are 34-36 days silent with fresh heartbeats; add per-entry dating and a heartbeat-vs-log freshness cross-check. Evidence: docs/reports/VALUE-REVIEW-repo-2026-09-19-consolidated.md C-39.
