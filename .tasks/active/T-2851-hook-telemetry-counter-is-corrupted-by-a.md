---
id: T-2851
name: "Hook telemetry counter is corrupted by an unlocked read-modify-write"
description: >
  _fw_telemetry_increment in the vendored hook-telemetry.sh reads the whole counter
  file, edits in memory, then truncate-writes it back with no lock and no atomic rename.
  Concurrent hooks tear the file, producing malformed lines and duplicate keys. The
  summing reader feeds the T-1626 decay-alarm denominator, so duplicates halve the
...
### 2026-08-29T09:52:33Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/termlink/.tasks/active/T-2851-hook-telemetry-counter-is-corrupted-by-a.md
