...
description: >
  substrate_status backpressure reports 4 of 5 hubs reachable; laptop-141 (192.168.10.141:9100)
  refuses connection. Not at capacity or rate-limited — simply down. Per PL-219 an
  unreachable hub is informational rather than firing, so nothing escalates it; confirm
  whether the host is intentionally offline or the hub needs restarting through its
  systemd unit (G-070).
