...
description: >
  hubs.toml is parsed by three independent implementations with nothing verifying they agree, so the CLI and MCP planes can disagree about which hubs exist for the same file. Same shape as the three artifact lists T-2751 closed. Options: cross-check, consolidate, or accept-and-document. Found while declining herdr rank 21 (T-2752).
...
last_update: 2026-08-15T21:38:37Z
date_finished: null
