---
id: T-2519
name: "termlink_interact panics on UTF-8 output split at snapshot boundary — raw byte slice not char-boundary-safe"
description: >
  termlink_interact slices full_output[pre_len..] at a raw byte offset (byte-len of an independently utf8-lossy-decoded pre-snapshot) with no char-boundary check; UTF-8 output split at a PTY read boundary panics 'byte index N is not a char boundary'. Fix: extract output_delta() helper using str::get with fallback.
...
last_update: 2026-08-03T22:11:03Z
date_finished: null
