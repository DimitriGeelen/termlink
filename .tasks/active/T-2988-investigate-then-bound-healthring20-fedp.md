...
description: >
  S-14/C-14,C-15: measure subscriber cursors on health:ring20-fedprobe first, then bound retention; add a rate-based trigger to the forever-topic canary so growth rate (not only absolute count) fires. Evidence: docs/reports/VALUE-REVIEW-repo-2026-09-19-consolidated.md C-14, C-15.
