...
description: >
  S-25/C-26 alt half: T-2069 duplicates tiny pure helpers across CLI and MCP crates by convention; add a paired-commit drift check that flags a commit touching one twin without the other (no change to the T-2069 convention itself). Evidence: docs/reports/VALUE-REVIEW-repo-2026-09-19-consolidated.md C-26.
