...
owner: agent
horizon: next
tags: [verb1, consistency, refactor, tech-debt]
components: []
related_tasks: []
...
cost_estimate_proposed:
  - ts: '2026-09-08T21:30:39Z'
    ...
    rationale: blast_radius=? (no-components-UNMEASURED-not-zero); tier=3 
      (workflow:refactor); effort=6 (lines=145,acs=4)
    rubric_sha: e4a00f38e801
---
...
### 2026-08-10T20:42:04Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/termlink/.tasks/active/T-2601-extract-a-single-shared-agent-liveness-p.md
