...
description: >
  S-22/C-45,C-30: no per-tool/per-verb invocation counts exist (incl. kv.* session-daemon blind spot); non-use judgements were capped at reading D (UNMEASURED). Instrument invocation counts so the next review can judge usage. Evidence: docs/reports/VALUE-REVIEW-repo-2026-09-19-consolidated.md C-45, C-30.
