---
id: T-2606
name: "Exactly-once is in-memory-only (dedupe LRU) under a durable replay queue —
  double-apply across hub restart/crash (design-first)"
description: >
  Verb-2 hunt F1+F3: PostDedupe LRU wiped on restart but outbound.sqlite replays;
  Envelope has no client_msg_id token
...
cost_estimate_proposed:
  - ts: '2026-09-08T21:30:39Z'
    ...
    rationale: blast_radius=? (no-components-UNMEASURED-not-zero); tier=2 
      (workflow:build); effort=8 (lines=201,acs=7)
    rubric_sha: e4a00f38e801
---
