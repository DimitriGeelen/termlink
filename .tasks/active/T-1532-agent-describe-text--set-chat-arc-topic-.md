...
( cargo build --release --bin termlink 2>&1 | tail -5 ) > /tmp/.v-t-1532-1.out && grep -q -E "Compiling|Finished" /tmp/.v-t-1532-1.out
( target/release/termlink agent describe --help 2>&1 ) > /tmp/.v-t-1532-2.out && grep -q -- 'TEXT' /tmp/.v-t-1532-2.out
