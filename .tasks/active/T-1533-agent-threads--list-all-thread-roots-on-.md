...
last_update: 2026-05-05T09:21:47Z
...
( cargo build --release --bin termlink 2>&1 | tail -5 ) > /tmp/.v-t-1533-1.out && grep -q -E "Compiling|Finished" /tmp/.v-t-1533-1.out
( target/release/termlink agent threads --help 2>&1 ) > /tmp/.v-t-1533-2.out && grep -q -- "agent" /tmp/.v-t-1533-2.out
