...
( cargo build --release -p termlink 2>&1 | tail -5 ) > /tmp/.v-t-1498-1.out && grep -q -E "Compiling|Finished" /tmp/.v-t-1498-1.out
( target/release/termlink agent recent --help 2>&1 ) > /tmp/.v-t-1498-2.out && grep -q -- "--watch" /tmp/.v-t-1498-2.out
( target/release/termlink agent recent --help 2>&1 ) > /tmp/.v-t-1498-3.out && grep -q -- "--watch-interval" /tmp/.v-t-1498-3.out
( target/release/termlink agent recent --target-fp d1993c2c3ec44c94 --watch --json 2>&1 ) > /tmp/.v-t-1498-4.out && grep -qiE "incompatible|--watch.*--json|--json.*--watch" /tmp/.v-t-1498-4.out
