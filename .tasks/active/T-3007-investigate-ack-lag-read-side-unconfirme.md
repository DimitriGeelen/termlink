...
description: >
  S-29/C-43: awaiting-ack rows age without a read-side consumer acting on them; investigate whether the lag is recipient-side or tracker-side. Evidence: docs/reports/VALUE-REVIEW-repo-2026-09-19-consolidated.md C-43.
