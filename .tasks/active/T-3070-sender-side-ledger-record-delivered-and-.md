...
description: >
  Spec step 6. The sender must record in its OWN ledger that a message was delivered, and later injected. Today the sender can only poll hub receipts; there is no local record, so a sender that restarts loses all knowledge of what it is waiting on.
...
last_update: 2026-09-22T12:52:47Z
date_finished: null
