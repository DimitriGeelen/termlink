...
( cargo build --release --bin termlink 2>&1 | tail -5 ) > /tmp/.v-t-1535-1.out && grep -q -E "Compiling|Finished" /tmp/.v-t-1535-1.out
( target/release/termlink agent pin-history --help 2>&1 ) > /tmp/.v-t-1535-2.out && grep -q -- "agent" /tmp/.v-t-1535-2.out
