---
id: T-1495
name: "agent overview — single-shot fleet digest combining presence + by-project +
  recent posts"
description: >
  agent overview — single-shot fleet digest combining presence + by-project + recent
  posts
...
- **Command(s):** `target/release/termlink agent overview --window-secs 86400`
- **Result:** exit=0; ok
- **Output:**
  ```
