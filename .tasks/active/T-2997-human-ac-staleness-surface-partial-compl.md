...
description: >
  S-23/C-21 surface half: 75 partial-complete tasks await human ACs with no ageing surface; add a session-start surface for partial-complete tasks older than a threshold, refresh G-008. Evidence: docs/reports/VALUE-REVIEW-repo-2026-09-19-consolidated.md C-21.
