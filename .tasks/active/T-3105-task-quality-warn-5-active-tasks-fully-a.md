---
id: T-3105
name: "Task-quality WARN: 5 active tasks fully agent+human ticked but not closed"
description: >
  fw audit WARN (Task Quality section): T-1428, T-1451, T-212, T-2828, T-3044 have
  every Agent AC ticked and no Human AC outstanding, but remain started-work/issues.
  1 of these has an empty Verification block (no mechanical close gate). Full list:
  .context/audits/unclosed-satisfied/LATEST.md. Distinct check from CTL-029 (broader
...
Narrower sibling of CTL-029 (already governed by T-3016): this check requires no outstanding Human AC at all, not merely all-Agent-ACs-ticked.
