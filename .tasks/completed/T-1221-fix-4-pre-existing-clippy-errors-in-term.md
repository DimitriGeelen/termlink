...
description: >
  Workspace clippy has 4 errors in mirror_grid.rs (279, 289, 564) and mirror_grid_composer.rs
  (222) — 3× collapsible_if + 1× manual_range_patterns. Surfaced by cargo clippy --workspace
  --tests -- -D warnings. Blocks full-workspace clippy verification on every Rust-touching
  task (G-015 adjacency). Safe fixes per clippy's own help output.
