---
id: T-1151
name: "Extend T-1150 — wire load_episodic_yaml into tasks.py and inception.py task-detail
  pages"
description: >
  Extend T-1150 — wire load_episodic_yaml into tasks.py and inception.py task-detail
  pages
