---
id: T-1381
name: "channel relations <topic> <offset> — unified per-offset navigation: replies
  + reactions + edits + redactions + forwards in one view"
description: >
  channel relations <topic> <offset> — unified per-offset navigation: replies + reactions
  + edits + redactions + forwards in one view
