---
id: T-2491
name: "remote-exec and session-exec --json branches fail open reporting ok:true exit
  0 when exit_code is missing"
description: >
  remote-exec and session-exec --json branches fail open reporting ok:true exit 0
  when exit_code is missing
...
horizon:
tags: []
components: [crates/termlink-cli/src/commands/mod.rs, 
