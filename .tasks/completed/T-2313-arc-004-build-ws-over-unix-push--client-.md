---
id: T-2313
name: "arc-004 build: WS-over-Unix push — client connect_ws_unix + route Unix --push
  (T-2312 GO)"
description: >
  arc-004 build: WS-over-Unix push — client connect_ws_unix + route Unix --push (T-2312
  GO)
