---
id: T-1589
name: "termlink_agent_busiest_threads + termlink_agent_recent_decisions — top-thread
  leaderboard + decision-bearing post heuristic search MCP read tools"
description: >
  termlink_agent_busiest_threads + termlink_agent_recent_decisions — top-thread leaderboard
  + decision-bearing post heuristic search MCP read tools
...
### 2026-05-20T13:23:34Z — phase-a-batch-close [agent-evidence]
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_busiest_threads`, `termlink_agent_recent_decisions`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
