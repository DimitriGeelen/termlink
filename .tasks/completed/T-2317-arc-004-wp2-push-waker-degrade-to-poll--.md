---
id: T-2317
name: "arc-004 WP2: push-waker degrade-to-poll + no-double-wake under WS drop (T-2315
  GO, Option A)"
description: >
  Loopback wire evidence that the push-waker survives a WS drop: subscribe reconnects
  (inherits T-2314), an inbound deposit during/after the blip rings the PTY exactly
  once (no double-wake, no lost DM), and the durable path remains the floor.
