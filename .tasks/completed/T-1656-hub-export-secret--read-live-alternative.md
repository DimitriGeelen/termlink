---
id: T-1656
name: "hub export-secret — read-live alternative to cat ~/.termlink/secrets/<IP>.hex
  (G-011 R3 facet 2)"
description: >
  hub export-secret — read-live alternative to cat ~/.termlink/secrets/<IP>.hex (G-011
  R3 facet 2)
