---
id: T-1584
name: "termlink_agent_topic_metadata_history + termlink_agent_reactions_by — description
  audit log + per-sender reaction history MCP read tools"
description: >
  termlink_agent_topic_metadata_history + termlink_agent_reactions_by — description
  audit log + per-sender reaction history MCP read tools
