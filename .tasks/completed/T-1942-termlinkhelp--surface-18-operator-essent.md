...
description: >
  Help registry has 252 real MCP tools but only surfaces 179. Surface Tier-1 operator-essentials
  (events, inbox, remote, net_test, recent_dm, agent_listen, agent_overview, agent_typing,
  agent_help, etc.). Dedup termlink_agent_ask (appears in agent_presence AND diagnostics).
