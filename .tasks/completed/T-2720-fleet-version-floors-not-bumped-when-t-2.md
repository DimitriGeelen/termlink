---
id: T-2720
name: "Fleet version floors not bumped when T-2533 shipped — canary green on known-bad
  binaries"
description: >
  check-fleet-binary-freshness.sh reports healthy while every reachable hub serves
  a binary 151-192 commits below the T-2533 silent-data-loss fix, because fleet-version-floors.conf
  was last bumped 2026-07-27 and T-2533 shipped a hub-side rail on 2026-08-08 without
  bumping it
