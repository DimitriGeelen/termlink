---
id: T-2216
name: "align claim error symbols across operator docs+skills with real error_code
  enum (kill fictional CLAIM_LAPSED/CLAIM_ALREADY_HELD)"
description: >
  align claim error symbols across operator docs+skills with real error_code enum
  (kill fictional CLAIM_LAPSED/CLAIM_ALREADY_HELD)
