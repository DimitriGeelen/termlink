---
id: T-2411
name: "Bind per-agent identity into reachable claude session (doorbell respond gap
  + shared-host fp leak, T-1693)"
description: >
  Bind per-agent identity into reachable claude session (doorbell respond gap + shared-host
  fp leak, T-1693)
