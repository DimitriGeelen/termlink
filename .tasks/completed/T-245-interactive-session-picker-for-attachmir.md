---
id: T-245
name: "Interactive session picker for attach/mirror/stream — list and select when
  no target given"
description: >
  Inception: Interactive session picker for attach/mirror/stream — list and select
  when no target given
