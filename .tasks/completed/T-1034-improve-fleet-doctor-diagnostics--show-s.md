---
id: T-1034
name: "Improve fleet-doctor diagnostics — show secret file path and suggest fix for
  auth failures"
description: >
  Improve fleet-doctor diagnostics — show secret file path and suggest fix for auth
  failures
