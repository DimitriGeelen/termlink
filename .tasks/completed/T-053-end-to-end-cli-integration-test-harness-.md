---
id: T-053
name: "End-to-end CLI integration test harness — automated multi-process terminal
  testing"
description: >
  Inception: End-to-end CLI integration test harness — automated multi-process terminal
  testing
