---
id: T-1576
name: "termlink_agent_info + termlink_agent_peers — orientation MCP read tools (topic
  snapshot + participant directory)"
description: >
  termlink_agent_info + termlink_agent_peers — orientation MCP read tools (topic snapshot
