...
description: >
  Enrich essentials mode rows with category_description (T-1957 source). Gives LLMs
  cold-starting via the essentials view both the canonical tool name AND the category's
  purpose in one entry. Drift-proof — derived live from category_descriptions().
