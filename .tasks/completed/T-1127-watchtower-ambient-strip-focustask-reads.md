---
id: T-1127
name: "Watchtower ambient strip focus_task reads first-alphabetical active task, not
  actual focus.yaml"
description: >
  Watchtower ambient strip focus_task reads first-alphabetical active task, not actual
  focus.yaml
