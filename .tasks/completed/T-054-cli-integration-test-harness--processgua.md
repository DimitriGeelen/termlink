---
id: T-054
name: "CLI integration test harness — ProcessGuard, wait_for_socket, and end-to-end
  test scenarios"
description: >
  CLI integration test harness — ProcessGuard, wait_for_socket, and end-to-end test
  scenarios
