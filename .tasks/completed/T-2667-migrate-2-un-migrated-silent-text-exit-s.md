---
id: T-2667
name: "Migrate 2 un-migrated silent-text-exit siblings (session list, remote discover)
  — T-2663 class"
description: >
  session.rs cmd_list + remote.rs cmd_remote_list_inner exit(1) bare in text mode
  on no-match; mirror T-2663 metadata.rs eprintln remediation
