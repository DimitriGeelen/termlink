---
id: T-1763
name: "termlink_channel_emoji_stats MCP — per-emoji + per-sender breakdown on arbitrary
  topic (T-1166 wedge)"
description: >
  Port channel emoji-stats CLI verb to MCP. Value-add over agent_emoji_stats: topic-flexible,
  per-sender reactor breakdown, respects redactions.
