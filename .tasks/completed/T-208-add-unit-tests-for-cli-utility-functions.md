...
T-205 extracted `util.rs` with 7 utility functions but only 5 ANSI-stripping tests. Add tests for `truncate`, `parse_signal`, `shell_escape`, `resize_payload`, and `generate_request_id`.
