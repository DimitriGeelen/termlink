---
id: T-1582
name: "termlink_agent_active_now + termlink_agent_history — recent-activity window
  + per-sender feed MCP read tools"
description: >
  termlink_agent_active_now + termlink_agent_history — recent-activity window + per-sender
  feed MCP read tools
