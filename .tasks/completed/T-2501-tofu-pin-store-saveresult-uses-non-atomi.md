---
id: T-2501
name: "TOFU pin store save_result uses non-atomic truncate-write — crash mid-write
  truncates known_hubs, silent trust downgrade"
description: >
  TOFU pin store save_result uses non-atomic truncate-write — crash mid-write truncates
  known_hubs, silent trust downgrade
