---
id: T-2670
name: "cmd_agent_negotiate subscribe-retry Err arm has no backoff — CPU busy-loop,
  silent"
description: >
  cmd_agent_negotiate's event.subscribe retry loop (agent.rs:239-241) logs+loops on
  Err with no backoff sleep; a dead/half-open hub errors instantly so the loop pins
  a CPU core silently until timeout_dur expires. Same T-2658/T-2636/T-2640 busy-spin
  class; sibling cmd_watch_hub already backs off 500ms.
...
date_finished: 2026-08-12T22:32:11Z
...
- **Scan ID:** R-87206769
- **Timestamp:** 2026-08-12T22:32:46Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-12T22:32:11Z — status-update [task-update-agent]
