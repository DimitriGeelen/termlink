---
id: T-2498
name: "flush silently wedges entire durable queue when head row fails to deserialize
  — peek Err collapsed into empty-queue break"
description: >
  flush silently wedges entire durable queue when head row fails to deserialize —
  peek Err collapsed into empty-queue break
...
date_finished: 2026-08-02T11:36:21Z
...
- **Scan ID:** R-3e3c7a94
- **Timestamp:** 2026-08-02T11:36:24Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 2
...
**Verification-level findings:**
  ...
  2. **l387-sigpipe-risk** (partial, heuristic) @ Verification:line 32
     - evidence: `cargo test -p termlink-session --lib offline_queue 2>&1 | tail -5 | grep -q "test result: ok"`

### 2026-08-02T11:36:21Z — status-update [task-update-agent]
