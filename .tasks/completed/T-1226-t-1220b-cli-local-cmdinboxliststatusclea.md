...
description: >
  Migrate cmd_inbox_list in crates/termlink-cli/src/commands/infrastructure.rs (@839)
  to use T-1225's list_with_fallback helper. cmd_inbox_status (aggregation) and cmd_inbox_clear
  (Q4 spool-deletion semantics) split out as follow-ups — see Decisions section.
