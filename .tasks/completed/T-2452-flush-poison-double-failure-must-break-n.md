---
id: T-2452
name: "flush poison double-failure must break not loop — avoid unbounded re-POST under
  disk-full (round-11 F2)"
description: >
  flush poison double-failure must break not loop — avoid unbounded re-POST under
  disk-full (round-11 F2)
