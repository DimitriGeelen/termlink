---
id: T-1842
name: "agent-listeners.sh + fleet variant: treat -32013 unknown topic as 0 listeners,
  not subscribe failure (G-060 graceful degradation)"
description: >
  agent-listeners.sh + fleet variant: treat -32013 unknown topic as 0 listeners, not
  subscribe failure (G-060 graceful degradation)
