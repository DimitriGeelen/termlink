---
id: T-2524
name: "download_artifact_via_client unbounded accumulation — peer-streamed blob OOMs
  receiver (no size cap)"
description: >
  download_artifact_via_client unbounded accumulation — peer-streamed blob OOMs receiver
  (no size cap)
...
horizon:
tags: []
components: [crates/termlink-session/src/artifact.rs]
related_tasks: []
...
date_finished: 2026-08-04T11:08:37Z
...
- **Scan ID:** R-ac8b73e0
- **Timestamp:** 2026-08-04T11:08:39Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-04T11:08:37Z — status-update [task-update-agent]
