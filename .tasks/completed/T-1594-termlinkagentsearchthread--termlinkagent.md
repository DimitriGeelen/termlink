---
id: T-1594
name: "termlink_agent_search_thread + termlink_agent_unanswered — per-thread content
  search + zero-reply detection MCP read tools"
description: >
  termlink_agent_search_thread + termlink_agent_unanswered — per-thread content search
  + zero-reply detection MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_search_thread`, `termlink_agent_unanswered`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
