---
id: T-2443
name: "await-ack must not forfeit offline-queue durability — route Unix post through
  the durable queue"
description: >
  await-ack must not forfeit offline-queue durability — route Unix post through the
  durable queue
