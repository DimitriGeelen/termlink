---
id: T-1600
name: "termlink_agent_self_replies + termlink_agent_first_responders — sender-self-continuations
  + fastest-first-replier leaderboard MCP read tools"
description: >
  termlink_agent_self_replies + termlink_agent_first_responders — sender-self-continuations
  + fastest-first-replier leaderboard MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_self_replies`, `termlink_agent_first_responders`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
