---
id: T-2752
name: "README Installation section contradicts Quick Start — omits install.sh, the
  recommended path"
description: >
  README Installation section contradicts Quick Start — omits install.sh, the recommended
  path
