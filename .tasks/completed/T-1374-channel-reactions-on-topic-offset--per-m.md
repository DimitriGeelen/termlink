---
id: T-1374
name: "channel reactions-on <topic> <offset> — per-message reaction aggregate (Matrix
  annotation rollup)"
description: >
  channel reactions-on <topic> <offset> — per-message reaction aggregate (Matrix annotation
  rollup)
