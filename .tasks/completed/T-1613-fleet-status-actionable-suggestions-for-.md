---
id: T-1613
name: "fleet status: actionable suggestions for misconfigured profiles (Secret-file-not-found,
  /tmp residue)"
description: >
  fleet status: actionable suggestions for misconfigured profiles (Secret-file-not-found,
  /tmp residue)
