---
id: T-1764
name: "termlink_channel_digest MCP — period summary with reactions/pins/forwards on
  arbitrary topic (T-1166 wedge)"
description: >
  Port channel digest CLI verb to MCP. Major value-add over agent_digest: includes
  top_reactions, pins_added/removed, forwards_in, content-only posts count, recent_chats
  with payload — agent_digest has none of these.
