---
id: T-1952
name: "termlink_help — add tool_detail mode for one-tool drill-in (closes 3-step discovery
  loop)"
description: >
  Return full macro description for a named tool — extract from source via cached
  regex
