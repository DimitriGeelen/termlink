---
id: T-2304
name: "Fix sys.path bug in update-task.sh inception-scope-trace — __file__ is <stdin>
  in heredoc, breaks lib.inception_decisions import"
description: >
  Fix sys.path bug in update-task.sh inception-scope-trace — __file__ is <stdin> in
  heredoc, breaks lib.inception_decisions import
