---
id: T-1824
name: "fleet secrets-audit --target-cache <PATH> — narrow drift check to one named
  cache file (T-1822 follow-up #1)"
description: >
  fleet secrets-audit --target-cache <PATH> — narrow drift check to one named cache
  file (T-1822 follow-up #1)
