...
description: >
  Usability #3 (actionable errors): post/subscribe/claim/claims/claims_summary return
  bare 'unknown topic'/'topic not found' with no next step, while sibling sweep/delete
  handlers already hint 'create it first'. Enrich to name topic + remediation.
...
date_finished: 2026-08-11T15:43:49Z
...
- **Scan ID:** R-ed427f4e
- **Timestamp:** 2026-08-11T15:44:52Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-11T15:43:49Z — status-update [task-update-agent]
