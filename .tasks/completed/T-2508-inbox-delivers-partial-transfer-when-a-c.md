...
description: >
  deliver_transfer verifies chunks are readable but not that the set is contiguous
  0..total_chunks; a missing chunk is delivered as a hole and the only copy is destroyed
