---
id: T-1762
name: "termlink_channel_ancestors MCP — reply-chain root→leaf for arbitrary topic
  (T-1166 wedge)"
description: >
  Port channel ancestors CLI verb to MCP. agent_ancestors is hardcoded to agent-chat-arc;
  channel_ancestors accepts topic param. Extract pure compute_ancestors_mcp helper
