...
description: >
  Add MCP tool wrapping scripts/agent-chat-arc-recent.sh — agent-callable parity with
  termlink_fleet_adoption_snapshot (T-1847) and termlink_agent_listeners_fleet (T-1839).
  Completes MCP coverage of the discovery triangle.
