---
id: T-1711
name: "termlink_fleet_status MCP — add verbose flag (per-hub session names, G-057
  punch-list #2)"
description: >
  termlink_fleet_status MCP — add verbose flag (per-hub session names, G-057 punch-list
  #2)
