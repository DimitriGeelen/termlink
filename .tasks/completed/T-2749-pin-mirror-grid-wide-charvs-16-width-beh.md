---
id: T-2749
name: "Pin mirror-grid wide-char/VS-16 width behaviour with a characterization test,
  then decide (herdr rank 22)"
description: >
  mirror_grid.rs drops combining marks and unicode-width 0.1 measures emoji-presentation
  as 1 while terminals draw 2; pin current behaviour and record an explicit decision
  rather than upgrading by momentum
