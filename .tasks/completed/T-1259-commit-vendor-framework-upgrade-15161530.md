---
id: T-1259
name: "Commit vendor framework upgrade 1.5.16→1.5.307 + preserve CLAUDE.md consumer
  path note"
description: >
  Commit vendor framework upgrade 1.5.16→1.5.307 + preserve CLAUDE.md consumer path
  note
