---
id: T-752
name: "Fix stdout buffering on JSON error exit — 222 process::exit calls lose output
  when piped"
description: >
  Fix stdout buffering on JSON error exit — 222 process::exit calls lose output when
  piped
...
components: [crates/termlink-cli/src/commands/agent.rs, 
      ...
      crates/termlink-cli/src/commands/pty.rs, 
      ...
      crates/termlink-cli/src/commands/token.rs, 
...
cost_estimate_proposed:
  - ts: '2026-08-18T18:59:20Z'
    ...
    cost_estimate:
      ...
      tier: 2
      effort: 7
    rationale: blast_radius=9 (no-signal); tier=2 (no-signal); effort=7 
      (no-signal)
    rubric_sha: missing
---
