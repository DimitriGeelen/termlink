...
description: >
  MCP fleet_verify emits {ok, verdict, profiles, message}; CLI emits {verdict, profiles,
  note}. Add ok to CLI, rename note->message, align text. Add parity_fleet_verify_no_hubs
  test.
