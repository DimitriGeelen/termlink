---
id: T-2646
name: "surface best-effort state-write failures in remote.rs fleet-doctor (escalation
  defeat + dup learnings)"
description: >
  surface best-effort state-write failures in remote.rs fleet-doctor (escalation defeat
  + dup learnings)
