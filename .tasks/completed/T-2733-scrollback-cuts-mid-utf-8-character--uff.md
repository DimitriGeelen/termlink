---
id: T-2733
name: "Scrollback cuts mid-UTF-8 character — U+FFFD corruption on --bytes and ring
  overflow (herdr item 5)"
description: >
  Scrollback cuts mid-UTF-8 character — U+FFFD corruption on --bytes and ring overflow
  (herdr item 5)
