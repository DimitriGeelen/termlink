---
id: T-2449
name: "clamp token create TTL to a ceiling — bound captured-token reuse window (T-2447
  F2)"
description: >
  clamp token create TTL to a ceiling — bound captured-token reuse window (T-2447
  F2)
