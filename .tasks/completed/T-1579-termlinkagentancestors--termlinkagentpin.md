---
id: T-1579
name: "termlink_agent_ancestors + termlink_agent_pin_history — reply-chain walk +
  curation event log MCP read tools"
description: >
  termlink_agent_ancestors + termlink_agent_pin_history — reply-chain walk + curation
  event log MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_ancestors`, `termlink_agent_pin_history`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
