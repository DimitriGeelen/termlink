---
id: T-2388
name: "tl-claude --reachable: auto-armed injectable agent launcher + @reboot re-arm
  (T-2380 C7+C5, arc-004 dormancy root fix)"
description: >
  tl-claude --reachable: auto-armed injectable agent launcher + @reboot re-arm (T-2380
  C7+C5, arc-004 dormancy root fix)
