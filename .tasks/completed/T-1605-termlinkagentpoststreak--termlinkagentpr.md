---
id: T-1605
name: "termlink_agent_post_streak + termlink_agent_presence_now — per-peer posting
  streak + live presence gauge MCP read tools"
description: >
  termlink_agent_post_streak + termlink_agent_presence_now — per-peer posting streak
  + live presence gauge MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_post_streak`, `termlink_agent_presence_now`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
