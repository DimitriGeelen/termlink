---
id: T-2503
name: "aggregator poll loop cursor stalls on missing next_seq — silent duplicate-event
  re-send storm"
description: >
  aggregator poll loop cursor stalls on missing next_seq — silent duplicate-event
  re-send storm
