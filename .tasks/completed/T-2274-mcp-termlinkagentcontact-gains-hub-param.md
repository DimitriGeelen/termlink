...
description: >
  T-2267 review item 4, slice 3 (findings 12). MCP termlink_agent_contact (tools.rs:17569)
  hardcodes the local socket (17596) and AgentContactParams (7388) has no hub field,
  so it cannot reach cross-hub at all. Add hub/hubs_file params; when local find_session
  (17621) misses, fall back to fleet presence resolution name->(hub,fp) via identity_fingerprint
  (T-2270 foundation). Depends on T-2270.
