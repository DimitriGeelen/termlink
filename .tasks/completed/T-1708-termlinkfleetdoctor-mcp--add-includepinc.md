---
id: T-1708
name: "termlink_fleet_doctor MCP — add include_pin_check + pin_check_summary (T-1666
  parity for LLM agents)"
description: >
  termlink_fleet_doctor MCP — add include_pin_check + pin_check_summary (T-1666 parity
  for LLM agents)
