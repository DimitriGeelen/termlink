...
description: >
  The list command has --names and --ids flags for piping session display names or
  IDs one per line. The discover command lacks these, forcing users to parse table
  output. Add both flags for scripting parity.
