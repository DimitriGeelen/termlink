...
Cycle 11 slice 5. T-1970 added `replacement_hint` (forward navigation: deprecated → live). This slice adds the reverse (`is_replacement_for[]`: live → list of deprecated pointing here). Bidirectional replacement graph in the catalog. Implementation: build a `OnceLock` reverse map by walking every category once; tool_detail emits the field.
...
### 2026-06-04T07:24:14Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/termlink/.tasks/active/T-1980-termlinkhelp-tooldetail-surfaces-isrepla.md
- **Context:** Initial task creation

### 2026-06-04T07:24:56Z — status-update [task-update-agent]
