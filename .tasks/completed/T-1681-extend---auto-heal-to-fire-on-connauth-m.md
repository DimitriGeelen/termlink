---
id: T-1681
name: "Extend --auto-heal to fire on conn=auth-mismatch transitions — close PL-162
  secret-only rotation gap"
description: >
  Extend --auto-heal to fire on conn=auth-mismatch transitions — close PL-162 secret-only
  rotation gap
...
date_finished: 2026-05-17T22:47:47Z
bvp_scores_proposed:
...
- **Scan ID:** R-29508041
- **Timestamp:** 2026-05-17T22:47:47Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-05-17T22:47:47Z — status-update [task-update-agent]
