---
id: T-1330
name: "channel react --remove — Matrix annotation removal (alias for redact on a reaction
  offset)"
description: >
  channel react --remove — Matrix annotation removal (alias for redact on a reaction
  offset)
