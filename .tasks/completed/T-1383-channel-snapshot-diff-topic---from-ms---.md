---
id: T-1383
name: "channel snapshot-diff <topic> --from <ms> --to <ms> — what changed between
  two timestamps (compose two T-1378 snapshots)"
description: >
  channel snapshot-diff <topic> --from <ms> --to <ms> — what changed between two timestamps
  (compose two T-1378 snapshots)
