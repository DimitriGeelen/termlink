---
id: T-2167
name: "Worker-side systemd template termlink-substrate-worker@.service + substrate-systemd.md
  walkthrough (T-2165 symmetry)"
description: >
  Worker-side systemd template termlink-substrate-worker@.service + substrate-systemd.md
  walkthrough (T-2165 symmetry)
