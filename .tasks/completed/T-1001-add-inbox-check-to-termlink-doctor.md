---
id: T-1001
name: "Add inbox check to termlink doctor"
description: >
...
- [x] `termlink doctor` includes inbox status check when hub is running
- [x] Doctor JSON output includes inbox field
...
### 2026-04-13T08:30:59Z — task-created [task-create-agent]
