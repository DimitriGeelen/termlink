...
description: >
  Make a reachable agent's auto-accept survive ANY relaunch (incl. plain claude --resume),
  not just tl-claude launches — the settings-based twin of the .mcp.json identity
  fix (T-2399). Closes the T-2400 residual: a manual relaunch reintroduces reachable-but-mute.
