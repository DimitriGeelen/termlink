---
id: T-2065
name: "fleet governor-status --watch --notify <CMD> — operator-pluggable event hook
  on per-hub governor transitions (T-2028 §6 #10 Track F)"
description: >
  fleet governor-status --watch --notify <CMD> — operator-pluggable event hook on
  per-hub governor transitions (T-2028 §6 #10 Track F)
