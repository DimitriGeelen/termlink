---
id: T-2266
name: "Fleet-wide sweep — relay orphaned peer pickups (ring20/025/etc) stranded on
  dead framework:pickup topic into AEF inbox"
description: >
  Fleet-wide sweep — relay orphaned peer pickups (ring20/025/etc) stranded on dead
  framework:pickup topic into AEF inbox
