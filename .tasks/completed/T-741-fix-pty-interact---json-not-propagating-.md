---
id: T-741
name: "Fix pty interact --json not propagating non-zero exit code and always reporting
  ok:true"
description: >
  Fix pty interact --json not propagating non-zero exit code and always reporting
  ok:true
