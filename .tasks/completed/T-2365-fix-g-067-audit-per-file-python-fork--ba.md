...
description: >
  Pre-push structure audit forks one python3 per task file (~2127) importing web.shared.parse_frontmatter;
  ~85s wall, intermittently kills pushes (exit 143). Batch into one python3 invocation.
  Land in AEF upstream, re-vendor into termlink.
