---
id: T-1599
name: "termlink_agent_user_summary + termlink_agent_first_post_by — composite peer
  profile + earliest-post-by-sender MCP read tools"
description: >
  termlink_agent_user_summary + termlink_agent_first_post_by — composite peer profile
  + earliest-post-by-sender MCP read tools
...
### 2026-05-20T13:23:40Z — phase-a-batch-close [agent-evidence]
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_user_summary`, `termlink_agent_first_post_by`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
