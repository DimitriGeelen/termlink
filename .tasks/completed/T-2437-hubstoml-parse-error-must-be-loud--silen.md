---
id: T-2437
name: "hubs.toml parse error must be loud — silent unwrap_or_default vanishes every
  hub + profile add can wipe the file"
description: >
  hubs.toml parse error must be loud — silent unwrap_or_default vanishes every hub
  + profile add can wipe the file
...
components: [crates/termlink-cli/src/commands/remote.rs, 
      crates/termlink-cli/src/config.rs]
related_tasks: []
...
date_finished: 2026-07-21T20:20:49Z
...
- **Scan ID:** R-d84e499c
- **Timestamp:** 2026-07-21T20:21:18Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-07-21T20:20:49Z — status-update [task-update-agent]
