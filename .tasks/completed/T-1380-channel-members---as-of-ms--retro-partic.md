---
id: T-1380
name: "channel members --as-of <ms> — retro participant view (Matrix-style backfill
  membership query, parallel to T-1378 snapshot)"
description: >
  channel members --as-of <ms> — retro participant view (Matrix-style backfill membership
  query, parallel to T-1378 snapshot)
