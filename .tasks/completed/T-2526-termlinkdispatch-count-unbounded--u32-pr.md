---
id: T-2526
name: "termlink_dispatch count unbounded — u32 pre-allocates ~100GB Vec, OOMs MCP
  server before spawn"
description: >
  termlink_dispatch count unbounded — u32 pre-allocates ~100GB Vec, OOMs MCP server
  before spawn
...
date_finished: 2026-08-04T11:25:08Z
...
- **Scan ID:** R-792529d8
- **Timestamp:** 2026-08-04T11:25:42Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-04T11:25:08Z — status-update [task-update-agent]
