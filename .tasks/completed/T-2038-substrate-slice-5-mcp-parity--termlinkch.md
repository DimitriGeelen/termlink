---
id: T-2038
name: "Substrate Slice 5: MCP parity — termlink_channel_claims tool (T-2037 follow-up)"
description: >
  Add MCP tool wrapping channel.claims so AI agents using TermLink-as-MCP can answer
  'what is currently claimed on this topic?' alongside their existing termlink_channel_claim/release/renew
  tools (T-2033). Same single-surface slicing as the prior MCP slice.
...
# T-2038: Substrate Slice 5: MCP parity — termlink_channel_claims tool (T-2037 follow-up)

## Context

T-2033 added `termlink_channel_claim/release/renew` MCP tools. T-2037
added the `channel.claims` listing RPC + Rust client + CLI. This
slice adds the MCP wrapper so AI agents on the wire have the same
introspection their operators have.
...
### 2026-06-07T20:18:45Z — task-created [task-create-agent]
