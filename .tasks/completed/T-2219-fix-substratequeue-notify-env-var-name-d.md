---
id: T-2219
name: "Fix substrate/queue notify env-var name drift in operator docs (silent-hook
  footgun)"
description: >
  Operator docs document TERMLINK_SUBSTRATE_FIELD/OLD/NEW and TERMLINK_OUTBOUND_QUEUE_PATH;
  source exports TERMLINK_SUBSTRATE_CHANGE_FIELD/OLD/NEW and the queue path knob is
  TERMLINK_IDENTITY_DIR. Copy-pasted notify-hook recipes silently never fire. Same
  doc-vs-source identifier drift class as T-2215/2216/2217 (error codes), now for
  env-var names.
