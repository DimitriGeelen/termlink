...
description: >
  193/344 cards have no edges and fw fabric enrich adds zero; most edgeless cards
  are leaf scripts whose real dependency is the termlink binary, which the file-to-file
  edge model cannot express
