...
description: >
  MCP returns crate Cargo.toml version (0.9.0/commit=unknown/target=unknown). CLI
  returns workspace build.rs git-derived (0.11.501/commit=8a1aafb0/target=x86_64-...).
  Both should report the same canonical version-source. Un-ignore parity_version when
  converged.
