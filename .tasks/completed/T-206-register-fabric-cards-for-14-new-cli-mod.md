...
T-205 split the CLI monolith (5183 lines) into 14 focused modules. The commit hook flagged that these new files lack fabric component cards. This task registers cards for all 14 files and updates the existing main.rs card and subsystems.yaml.
