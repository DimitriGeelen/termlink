---
id: T-1606
name: "termlink_agent_silence_gap + termlink_agent_age_distribution — longest peer
  absence + topic-wide post-age histogram MCP read tools"
description: >
  termlink_agent_silence_gap + termlink_agent_age_distribution — longest peer absence
  + topic-wide post-age histogram MCP read tools
...
### 2026-05-20T13:23:44Z — phase-a-batch-close [agent-evidence]
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_silence_gap`, `termlink_agent_age_distribution`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
