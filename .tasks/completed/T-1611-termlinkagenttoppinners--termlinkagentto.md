---
id: T-1611
name: "termlink_agent_top_pinners + termlink_agent_top_starrers — most-active curators
  leaderboards MCP read tools"
description: >
  termlink_agent_top_pinners + termlink_agent_top_starrers — most-active curators
  leaderboards MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_top_pinners`, `termlink_agent_top_starrers`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
