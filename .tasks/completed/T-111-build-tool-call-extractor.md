...
description: >
  Python script to extract tool call metadata from session JSONL transcripts (main
  + sidechain). Outputs metadata-only records to stdout as JSONL. Schema from T-104.
