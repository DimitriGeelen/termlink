---
id: T-2319
name: "Push-waker leaks its channel-subscribe child on be-reachable stop (orphan reconnect
  loop)"
description: >
  Push-waker leaks its channel-subscribe child on be-reachable stop (orphan reconnect
  loop)
