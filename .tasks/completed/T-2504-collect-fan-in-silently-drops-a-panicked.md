---
id: T-2504
name: "collect fan-in silently drops a panicked session poll task (JoinError swallowed,
  no log)"
description: >
  collect fan-in silently drops a panicked session poll task (JoinError swallowed,
  no log)
