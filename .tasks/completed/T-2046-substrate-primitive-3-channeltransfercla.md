...
description: >
  Implement the T-2021 GO decision per docs/reports/T-2021-pull-assign-rpc-inception.md.
  ONE new RPC: channel.transfer_claim(claim_id, to_owner, by, reason?). Atomic ownership
  transfer (cooperative + owner-checked, distinct from T-2044 force_release). Pull-side
  is pure composition of subscribe + claim — no new code. ~120 LOC across 4 vertical
  slices.
