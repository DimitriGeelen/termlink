---
id: T-2747
name: "MCP/CLI parity census check — convert unexamined pairs into acknowledged (herdr
  rank 13)"
description: >
  Guard-layer static check enumerating MCP tools vs CLI commands; fires on any pair
  neither covered by parity.rs nor allowlisted with a cited reason
...
horizon:
tags: []
components: [scripts/check-mcp-parity-census.sh, 
      tests/mcp-parity-census-fixtures.sh]
related_tasks: []
...
date_finished: 2026-08-15T20:43:34Z
...
### 2026-08-15T20:43:34Z — status-update [task-update-agent]
