---
id: T-1591
name: "termlink_agent_thread_summary + termlink_agent_active_in_thread — deep thread
  metrics + per-thread participants MCP read tools"
description: >
  termlink_agent_thread_summary + termlink_agent_active_in_thread — deep thread metrics
  + per-thread participants MCP read tools
