---
id: T-1604
name: "termlink_agent_co_posters + termlink_agent_daily_volume — co-thread peer affinity
  + per-day post volume histogram MCP read tools"
description: >
  termlink_agent_co_posters + termlink_agent_daily_volume — co-thread peer affinity
  + per-day post volume histogram MCP read tools
