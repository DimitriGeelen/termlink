---
id: T-2369
name: "Fix stale shadow termlink binaries on .107 + agent-presence retention-reset
  (clears substrate-preflight/unconfirmed-delivery/topic-growth canaries)"
description: >
  Fix stale shadow termlink binaries on .107 + agent-presence retention-reset (clears
  substrate-preflight/unconfirmed-delivery/topic-growth canaries)
...
date_finished: 2026-07-05T21:52:56Z
...
- **Scan ID:** R-86c4882f
- **Timestamp:** 2026-07-05T21:52:57Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 2
...
**Verification-level findings:**
  ...
  1. **empty-output-success** (partial, heuristic) @ Verification:line 34
     - evidence: `termlink channel awaiting-ack --json > /dev/null`
  2. **l387-sigpipe-risk** (partial, heuristic) @ Verification:line 32
     - evidence: `! which -a termlink | while read b; do "$b" --version; done | grep -q '0\.9\.'`

### 2026-07-05T21:52:56Z — status-update [task-update-agent]
