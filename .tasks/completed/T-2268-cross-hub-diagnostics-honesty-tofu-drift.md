---
id: T-2268
name: "Cross-hub diagnostics honesty: TOFU drift + version-skew + scope-vs-secret
  error surfacing"
description: >
  T-2267 review item 2. Surface TOFU cert-drift verbatim (currently swallowed into
  'is the hub running?'); on -32601 probe remote version and annotate skew-vs-typo
  (use -32011 PROTOCOL_VERSION_TOO_OLD data); split -32010 bad-credential vs insufficient-scope.
  See docs/reports/T-2267-comms-review.md Layer 3.
...
date_finished: 2026-06-24T08:34:20Z
...
### 2026-06-24T08:34:20Z — status-update [task-update-agent]
