---
id: T-2109
name: "agent.find_idle cv_index fast path — substrate primitives 2 + 9 cross-reference
  optimization"
description: >
  agent.find_idle cv_index fast path — substrate primitives 2 + 9 cross-reference
  optimization
