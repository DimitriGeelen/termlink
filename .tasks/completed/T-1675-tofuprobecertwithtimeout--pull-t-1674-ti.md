---
id: T-1675
name: "tofu::probe_cert_with_timeout — pull T-1674 timeout into the primitive; migrate
  all 8 callers"
description: >
  tofu::probe_cert_with_timeout — pull T-1674 timeout into the primitive; migrate
  all 8 callers
