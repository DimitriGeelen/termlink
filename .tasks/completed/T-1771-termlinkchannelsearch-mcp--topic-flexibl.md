...
description: >
  Port CLI cmd_channel_search (channel.rs:8535) to MCP. Four value-adds over termlink_agent_search:
  (1) topic-flexibility; (2) regex support; (3) all-flag to include meta msg-types;
  (4) richer row shape including msg_type. Reuses existing walk_topic_full_mcp helper.
