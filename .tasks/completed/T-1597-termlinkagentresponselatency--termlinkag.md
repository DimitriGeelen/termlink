---
id: T-1597
name: "termlink_agent_response_latency + termlink_agent_msg_growth_rate — median first-reply
  latency + week-over-week trend MCP read tools"
description: >
  termlink_agent_response_latency + termlink_agent_msg_growth_rate — median first-reply
  latency + week-over-week trend MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_response_latency`, `termlink_agent_msg_growth_rate`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
