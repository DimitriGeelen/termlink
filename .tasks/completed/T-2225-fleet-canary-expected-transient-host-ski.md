...
description: >
  Teach check-fleet-doorbell-mail-health.sh to treat operator-declared transient hosts
  (e.g. laptop-141) as expected-down so a sleeping laptop does not DRIFT the whole-fleet
  canary (G-019 alert-fatigue prevention).
