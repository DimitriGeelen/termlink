---
id: T-1686
name: "fleet history --include-heals — merge heal.log events into the rotation history
  view"
description: >
  fleet history --include-heals — merge heal.log events into the rotation history
  view
