---
id: T-1844
name: "agent-listeners.sh subscribe-from-tail — fix cursor=0 reading OLDEST not NEWEST
  envelopes (livelisten count always 0 on busy topics)"
description: >
  agent-listeners.sh subscribe-from-tail — fix cursor=0 reading OLDEST not NEWEST
  envelopes (livelisten count always 0 on busy topics)
