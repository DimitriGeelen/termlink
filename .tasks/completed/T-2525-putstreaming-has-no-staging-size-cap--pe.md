---
id: T-2525
name: "put_streaming has no staging size cap — peer exhausts hub disk + OOMs hub at
  finalize fs::read"
description: >
  put_streaming has no staging size cap — peer exhausts hub disk + OOMs hub at finalize
  fs::read
...
components: [crates/termlink-bus/src/artifact_store.rs, 
      crates/termlink-bus/src/error.rs]
related_tasks: []
