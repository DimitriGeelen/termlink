---
id: T-2244
name: "R2a substrate-fitness: change-retention-on-existing-topic path (enables Q1
  interim days:2 on agent-presence)"
description: >
  R2a substrate-fitness: change-retention-on-existing-topic path (enables Q1 interim
  days:2 on agent-presence)
