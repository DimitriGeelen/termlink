...
description: >
  BUG observability: background claim-renew loop swallows transient renew failures
  at debug and retries silently until the lease lapses. Fix: warn once now_ms past
  claimed_until. From T-2468 sweep.
