---
id: T-1183
name: "Fix fleet-status error classification — same PL-046 bug as T-1181 but in cmd_fleet_status
  (remote.rs:1443)"
description: >
  Fix fleet-status error classification — same PL-046 bug as T-1181 but in cmd_fleet_status
  (remote.rs:1443)
