---
id: T-2627
name: "channel release --ack defaults to false at raw CLI — silently reopens claimed
  slot for retry (footgun default)"
description: >
  channel release --ack defaults to false at raw CLI — silently reopens claimed slot
  for retry (footgun default)
...
date_finished: 2026-08-12T06:16:09Z
...
- **Scan ID:** R-311aab5e
- **Timestamp:** 2026-08-12T06:16:39Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-12T06:16:09Z — status-update [task-update-agent]
