---
id: T-1590
name: "termlink_agent_envelope + termlink_agent_who_is — single-offset hydrate + fingerprint→display-name
  resolver MCP read tools"
description: >
  termlink_agent_envelope + termlink_agent_who_is — single-offset hydrate + fingerprint→display-name
  resolver MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_envelope`, `termlink_agent_who_is`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
