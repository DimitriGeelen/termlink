---
id: T-1580
name: "termlink_agent_emoji_stats + termlink_agent_ack_history — topic-wide reaction
  aggregator + per-sender ack timeline MCP read tools"
description: >
  termlink_agent_emoji_stats + termlink_agent_ack_history — topic-wide reaction aggregator
  + per-sender ack timeline MCP read tools
