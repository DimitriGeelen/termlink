---
id: T-2489
name: "inbox deliver_transfer silently skips corrupt chunk then deletes spool causing
  unrecoverable file loss"
description: >
  inbox deliver_transfer silently skips corrupt chunk then deletes spool causing unrecoverable
  file loss
