---
id: T-2619
name: "history-log parsers silently drop entries with unparseable ts + undercount
  malformed"
description: >
  parse_find_idle_log + parse_substrate_log drop valid-JSON entries whose ts is unparseable,
  without counting them as malformed
