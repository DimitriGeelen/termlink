---
id: T-1581
name: "termlink_agent_edits_of + termlink_agent_topic_stats — per-post edit history
  + daily activity buckets MCP read tools"
description: >
  termlink_agent_edits_of + termlink_agent_topic_stats — per-post edit history + daily
  activity buckets MCP read tools
...
### 2026-05-20T13:23:29Z — phase-a-batch-close [agent-evidence]
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_edits_of`, `termlink_agent_topic_stats`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
