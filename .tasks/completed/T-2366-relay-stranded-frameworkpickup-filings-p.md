...
description: >
  Drop the two card-redirect-couriered filings (P-050 fw-update dispatch order, P-051
  unsolicited bd-init/help-init) that fell through the framework:pickup->AEF bridge
  (offsets 75/76, posted 2026-06-27, bridge dormant until 2026-07-05 resumed past
  them) directly into AEF .context/pickup/inbox/ via termlink_run. G-067 (offset 74)
  SKIPPED: already fixed upstream by AEF T-2297/T-2298.
