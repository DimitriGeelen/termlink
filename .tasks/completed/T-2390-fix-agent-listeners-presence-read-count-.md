---
id: T-2390
name: "Fix agent-listeners presence read: count-based seek-to-tail blind to live heartbeats
  under latest-per-cv-key retention"
description: >
  Fix agent-listeners presence read: count-based seek-to-tail blind to live heartbeats
  under latest-per-cv-key retention
...
date_finished: 2026-07-10T05:19:45Z
...
- **Scan ID:** R-1fd00f81
- **Timestamp:** 2026-07-10T05:19:46Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 1
...
**Verification-level findings:**
  ...
  1. **empty-output-success** (partial, heuristic) @ Verification:line 1
     - evidence: `bash scripts/agent-listeners.sh --help >/dev/null 2>&1`

### 2026-07-10T05:19:45Z — status-update [task-update-agent]
