---
id: T-1997
name: "termlink_help — limit/offset/sort_by route into flat-list branch on no-needle
  calls (cycle 12 slice 5)"
description: >
  termlink_help — limit/offset/sort_by route into flat-list branch on no-needle calls
  (cycle 12 slice 5)
