---
id: T-717
name: "Add --check flag to info command that exits non-zero if hub is stopped or sessions
  are stale"
description: >
  Add --check flag to info command that exits non-zero if hub is stopped or sessions
  are stale
