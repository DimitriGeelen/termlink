---
id: T-2066
name: "fleet governor-status --watch --log <FILE> — append-only NDJSON transition
  log (T-2028 §6 #10 Track G, audit-trail axis)"
description: >
  fleet governor-status --watch --log <FILE> — append-only NDJSON transition log (T-2028
  §6 #10 Track G, audit-trail axis)
