...
description: >
  release.yml runs cargo build --release and never cargo test, so a regression in
  the 2055-test workspace suite ships to GitHub Releases and Homebrew (T-2683 F1/G4).
...
horizon: null
tags: []
components: [crates/termlink-mcp/tests/parity.rs, scripts/check-canary-log-hygiene.sh, scripts/run-guard-layer.sh, tests/guard-layer-runner-fixtures.sh, tests/pickup-failopen-fixtures.sh]
related_tasks: []
...
last_update: 2026-08-27T09:53:06Z
date_finished: 2026-08-27T09:53:06Z
...
- **Scan ID:** R-79add182
- **Timestamp:** 2026-08-27T09:55:43Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-27T09:53:06Z — status-update [task-update-agent]
