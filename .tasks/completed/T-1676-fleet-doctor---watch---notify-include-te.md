---
id: T-1676
name: "fleet doctor --watch --notify: include TERMLINK_WATCH_TS in env-var contract
  (T-1669 follow-up)"
description: >
  fleet doctor --watch --notify: include TERMLINK_WATCH_TS in env-var contract (T-1669
  follow-up)
