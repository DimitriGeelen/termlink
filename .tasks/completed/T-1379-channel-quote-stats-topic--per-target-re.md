---
id: T-1379
name: "channel quote-stats <topic> — per-target reply rollup (per-target companion
  to T-1370 replies-of which is per-sender)"
description: >
  channel quote-stats <topic> — per-target reply rollup (per-target companion to T-1370
  replies-of which is per-sender)
