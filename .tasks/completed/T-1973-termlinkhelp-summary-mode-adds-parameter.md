---
id: T-1973
name: "termlink_help: summary mode adds parameter-count aggregates (cycle 10 slice
  4)"
description: >
  MCP arc cycle 10 slice 4: extend the summary-mode aggregate envelope (T-1963) with
  parameter-count rollups composing T-1971/T-1972. Adds total_parameters, zero_arity_tools
  count, and highest_arity_tools (top 5). All derived live from tool_params().
