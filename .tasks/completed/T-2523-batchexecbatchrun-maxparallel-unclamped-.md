---
id: T-2523
name: "batch_exec/batch_run max_parallel unclamped — Semaphore panic + zero-permit
  hang (MCP DoS)"
description: >
  batch_exec/batch_run max_parallel unclamped — Semaphore panic + zero-permit hang
  (MCP DoS)
