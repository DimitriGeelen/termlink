---
id: T-1577
name: "termlink_agent_redactions + termlink_agent_ack_status — curation log + receipt
  frontiers MCP read tools"
description: >
  termlink_agent_redactions + termlink_agent_ack_status — curation log + receipt frontiers
  MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_redactions`, `termlink_agent_ack_status`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
