---
id: T-1601
name: "termlink_agent_emoji_users + termlink_agent_orphan_replies — per-emoji top-user
  leaderboard + dangling-reply integrity check MCP read tools"
description: >
  termlink_agent_emoji_users + termlink_agent_orphan_replies — per-emoji top-user
  leaderboard + dangling-reply integrity check MCP read tools
