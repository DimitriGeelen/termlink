---
id: T-2312
name: "arc-004 WS-over-Unix push for co-located agents — should --push work over the
  Unix socket, not just TCP?"
description: >
  Inception: arc-004 WS-over-Unix push for co-located agents — should --push work
  over the Unix socket, not just TCP?
