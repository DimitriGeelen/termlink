---
id: T-2640
name: "dispatch event.collect loop — unbounded RPC await defeats --timeout on half-open
  hub (low)"
description: >
  dispatch.rs event.collect loop (~416) awaits rpc_call(event.collect) unbounded;
  collect_timeout is only checked at loop top, never concurrently, so a single wedged
  collect ignores the deadline. Err arm also continues with no backoff (bounded 5-iter
  micro-spin). Divergence F3 (T-2637), low severity.
...
date_finished: 2026-08-12T14:16:36Z
...
- **Scan ID:** R-142147be
- **Timestamp:** 2026-08-12T14:17:40Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-08-12T14:16:36Z — status-update [task-update-agent]
