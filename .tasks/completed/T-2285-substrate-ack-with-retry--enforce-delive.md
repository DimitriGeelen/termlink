---
id: T-2285
name: "Substrate ack-with-retry — enforce delivery receipts for parallel-exec harness
  (§9 hard-dep #5)"
description: >
  Inception: Substrate ack-with-retry — enforce delivery receipts for parallel-exec
  harness (§9 hard-dep #5)
