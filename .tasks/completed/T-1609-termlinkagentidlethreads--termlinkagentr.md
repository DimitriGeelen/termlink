---
id: T-1609
name: "termlink_agent_idle_threads + termlink_agent_reaction_rate — cold-thread surfacer
  + per-peer reactions-per-post popularity gauge MCP read tools"
description: >
  termlink_agent_idle_threads + termlink_agent_reaction_rate — cold-thread surfacer
  + per-peer reactions-per-post popularity gauge MCP read tools
