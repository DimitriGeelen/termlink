---
id: T-1725
name: "Verify project pre-commit hook runs secret-scan.sh + covers github_pat_ pattern
  (T-1695 prevention)"
description: >
  Verify project pre-commit hook runs secret-scan.sh + covers github_pat_ pattern
  (T-1695 prevention)
