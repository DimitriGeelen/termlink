...
description: >
  T-690 Phase 3-4: Update watch, wait, collect, and dispatch CLI commands to use event.subscribe
  when available, falling back to event.poll for older sessions.
