---
id: T-1376
name: "channel state <topic> — canonical collapsed view (edits applied, redactions
  hidden) — Matrix m.replace + m.redaction render"
description: >
  channel state <topic> — canonical collapsed view (edits applied, redactions hidden)
  — Matrix m.replace + m.redaction render
