---
id: T-2607
name: "Identity/trust plane silently relocates to volatile /tmp when HOME unset (portability
  + no-silent-failures)"
description: >
  Verb-portability hunt F1 (HIGH): tofu.rs known_hubs_path + offline_queue + ack_retry
  fall back to /tmp when HOME unset; tofu ignores TERMLINK_IDENTITY_DIR
