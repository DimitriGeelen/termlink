---
id: T-2386
name: "Reply-on-sender-hub routing convention — /reply + agent contact target recipient
  home hub derived from presence (comms loud-contract; fixes hub-split silent no-delivery,
  T-2380 C1/E1/G-060)"
description: >
  Sender and reader silently target different hubs for the same-named dm topic (no
  federation). Resolve the recipients home hub from agent-presence and route the contact/reply
  there; refuse or auto-route on mismatch. Attacks E1 root without full federation
  (C3 out of scope).
