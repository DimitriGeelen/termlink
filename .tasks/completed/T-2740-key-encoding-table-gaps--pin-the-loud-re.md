---
id: T-2740
name: "Key-encoding table gaps — pin the loud refusal, then widen resolve_key beyond
  its current subset"
description: >
  Key-encoding table gaps — pin the loud refusal, then widen resolve_key beyond its
  current subset
