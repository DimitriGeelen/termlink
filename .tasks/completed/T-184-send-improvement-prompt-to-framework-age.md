...
description: >
  Use TermLink cross-machine communication (TOFU TLS + hub forwarding) to inject a
  task-creation prompt into a framework Claude session running on 192.168.10.107.
  Tests T-178 + T-182 end-to-end for the real use case.
