---
id: T-1575
name: "termlink_agent_on_thread + termlink_agent_reactions — thread descent + per-offset
  reactions MCP read tools"
description: >
  termlink_agent_on_thread + termlink_agent_reactions — thread descent + per-offset
  reactions MCP read tools
