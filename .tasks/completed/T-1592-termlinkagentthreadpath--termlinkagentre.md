---
id: T-1592
name: "termlink_agent_thread_path + termlink_agent_reaction_summary — full-conversation
  walk + per-offset emoji breakdown MCP read tools"
description: >
  termlink_agent_thread_path + termlink_agent_reaction_summary — full-conversation
  walk + per-offset emoji breakdown MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_thread_path`, `termlink_agent_reaction_summary`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
