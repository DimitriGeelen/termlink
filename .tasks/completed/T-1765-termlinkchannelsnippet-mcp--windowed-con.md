---
id: T-1765
name: "termlink_channel_snippet MCP — windowed content preview around offset on arbitrary
  topic (T-1166 wedge)"
description: >
  Port channel snippet CLI verb to MCP. compute_snippet_mcp helper already exists
  (used by agent_snippet); this wedge adds topic-flexible tool wrapper.
