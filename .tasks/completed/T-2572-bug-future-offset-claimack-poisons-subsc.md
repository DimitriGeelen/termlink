...
description: >
  BUG: channel claim at an offset beyond the topic frontier, then release --ack, advances the subscriber cursor arbitrarily far past all real messages — silent unbounded data loss. Fix: reject a claim whose offset is beyond the current frontier. Found in T-2468 purpose-review verb-2 hunt.
...
horizon: null
tags: []
components: [crates/termlink-bus/src/error.rs, crates/termlink-bus/src/lib.rs, crates/termlink-bus/src/meta.rs, crates/termlink-hub/src/channel.rs, crates/termlink-protocol/src/control.rs]
related_tasks: []
...
last_update: 2026-08-09T14:52:29Z
