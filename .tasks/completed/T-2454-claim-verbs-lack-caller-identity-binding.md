---
id: T-2454
name: "claim verbs lack caller-identity binding — ownership on spoofable claimer string
  (round-12 HIGH)"
description: >
  Inception: claim verbs lack caller-identity binding — ownership on spoofable claimer
  string (round-12 HIGH)
