---
id: T-789
name: "Worktree isolation for TermLink-dispatched agents — git worktree per spawned
  session"
description: >
  Inception: Worktree isolation for TermLink-dispatched agents — git worktree per
  spawned session
