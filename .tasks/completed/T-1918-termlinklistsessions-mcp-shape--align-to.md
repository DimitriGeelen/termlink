---
id: T-1918
name: "termlink_list_sessions MCP shape — align to CLI envelope {ok,sessions} (parity
  v0.3 catch)"
description: >
  termlink_list_sessions MCP shape — align to CLI envelope {ok,sessions} (parity v0.3
  catch)
