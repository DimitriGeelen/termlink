---
id: T-1586
name: "termlink_agent_pinned_history + termlink_agent_starred_history — per-target
  pin/star audit log MCP read tools"
description: >
  termlink_agent_pinned_history + termlink_agent_starred_history — per-target pin/star
  audit log MCP read tools
...
### 2026-05-20T13:23:32Z — phase-a-batch-close [agent-evidence]
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_pinned_history`, `termlink_agent_starred_history`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
