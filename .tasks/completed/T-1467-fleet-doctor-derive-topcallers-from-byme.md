---
id: T-1467
name: "fleet doctor: derive top_callers from by_method fallback (works against pre-T-1460
  hubs)"
description: >
  fleet doctor: derive top_callers from by_method fallback (works against pre-T-1460
  hubs)
