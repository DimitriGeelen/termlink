---
id: T-2499
name: "hub secret load treats a transient read error as missing and silently regenerates
  — full fleet re-auth (PL-021 class)"
description: >
  hub secret load treats a transient read error as missing and silently regenerates
  — full fleet re-auth (PL-021 class)
...
date_finished: 2026-08-02T12:40:25Z
...
- **Scan ID:** R-bc3c9125
- **Timestamp:** 2026-08-02T12:40:30Z
- **Catalogue:** v1.3-seed
- **Overall:** CONCERN
- **Needs Human:** no
- **Findings:** 1
...
**Verification-level findings:**
  ...
  1. **l387-sigpipe-risk** (partial, heuristic) @ Verification:line 31
     - evidence: `cargo test -p termlink-hub --lib secret 2>&1 | tail -5 | grep -q "test result: ok"`

### 2026-08-02T12:40:25Z — status-update [task-update-agent]
