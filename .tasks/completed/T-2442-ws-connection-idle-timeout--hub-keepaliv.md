---
id: T-2442
name: "WS connection idle timeout + hub keepalive ping — close unauthenticated conn-cap
  DoS"
description: >
  WS connection idle timeout + hub keepalive ping — close unauthenticated conn-cap
  DoS
