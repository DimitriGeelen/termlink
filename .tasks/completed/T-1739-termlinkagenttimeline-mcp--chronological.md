...
description: >
  Port cmd_agent_timeline to MCP — chronological fleet log with thread/project/msg_type/grep
  filters. Helper-port pattern: extract_recent_posts_mcp + RecentPostMcp struct. T-1166
  MCP-parity arc continuation (after T-1738 snippet).
