---
id: T-2502
name: "hub secret written non-atomically — crash mid-write truncates hub.secret, silent
  fleet-wide re-auth (PL-021)"
description: >
  hub secret written non-atomically — crash mid-write truncates hub.secret, silent
  fleet-wide re-auth (PL-021)
