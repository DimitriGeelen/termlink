---
id: T-2130
name: "fix agent-find-idle.md schema description: claims.claimed_by → claims.claimer
  (PL-206 class instance)"
description: >
  fix agent-find-idle.md schema description: claims.claimed_by → claims.claimer (PL-206
  class instance)
