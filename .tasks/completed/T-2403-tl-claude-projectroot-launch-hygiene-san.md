---
id: T-2403
name: "tl-claude PROJECT_ROOT launch-hygiene: sanitize leaked env that misroutes agent
  project"
description: >
  tl-claude passes through whatever PROJECT_ROOT is in the launcher env; a leaked
  /opt/023 value misrouted workflow-designer's framework project resolution, gating
  fw/Bash/Edit in /opt/832. Sanitize PROJECT_ROOT at launch so a cwd-scoped agent
  resolves its own project.
