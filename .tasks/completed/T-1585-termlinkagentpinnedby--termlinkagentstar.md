---
id: T-1585
name: "termlink_agent_pinned_by + termlink_agent_starred_by — per-curator pin/star
  views MCP read tools"
description: >
  termlink_agent_pinned_by + termlink_agent_starred_by — per-curator pin/star views
  MCP read tools
...
- **Mechanical evidence:** Referenced MCP tool(s): `termlink_agent_pinned_by`, `termlink_agent_starred_by`. Registration verified in `crates/termlink-mcp/src/tools.rs`.
