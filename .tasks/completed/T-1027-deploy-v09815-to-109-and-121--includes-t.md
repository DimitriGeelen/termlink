...
description: >
  Build musl static binary, deploy to .109 (ring20-management) and .121 (ring20-dashboard)
  via termlink send-file. Includes T-1026 hub.tcp server-side write fix for reliable
  hub restart.
...
date_finished: 2026-04-23T19:17:05Z
bvp_scores_proposed:
...
### 2026-04-23T19:17:05Z — status-update [task-update-agent]
