---
id: T-1155
name: "Channel-based communication bus for TermLink agents — subsume event.broadcast
  + inbox + pickup + send-file"
description: >
  Inception: Channel-based communication bus for TermLink agents — subsume event.broadcast
  + inbox + pickup + send-file
