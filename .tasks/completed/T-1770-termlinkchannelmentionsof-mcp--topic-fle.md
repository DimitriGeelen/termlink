...
description: >
  Port CLI cmd_channel_mentions_of (channel.rs:5288) to MCP. Topic-flexible variant
  of termlink_agent_mentions (hardcoded chat-arc). Reuses existing compute_mentions_of_mcp
  helper. Use case: 'who tagged me in dm:* or project topics?'
