---
id: T-2947
name: "Pickup: audit.sh D8 handover-quality check can never PASS: handover.sh emits
  a (from termlink)"
description: >
...
created: 2026-09-09T18:10:02Z
last_update: 2026-09-16T16:07:52Z
date_finished: 2026-09-16T16:07:52Z
...
# T-2947: Pickup: audit.sh D8 handover-quality check can never PASS: handover.sh emits a (from termlink)

## Context

This task is a **re-mint of this project's own outbound filing**, not inbound work.
Envelope `P-073` was created by local task **T-2943**, which completed at 2026-09-09T18:22:37Z and
filed the finding upstream at `framework:pickup` offset **115**. `fw pickup send`
...
envelope **twice** — this task at 2026-09-09T18:10:02Z, its twin T-2946 60s later.
...
- [x] Origin task **T-2943** is confirmed `work-completed` (finished 2026-09-09T18:22:37Z) and its finding was filed upstream at `framework:pickup` offset 115 — so the work this envelope describes is already done and already reported. Verified by command, not asserted.
...
grep -q '^status: work-completed' .tasks/completed/T-2943-d8-audit-check-can-never-pass-generator-.md
...
### 2026-09-09T18:10:02Z — task-created [task-create-agent]
- **Action:** Created task via task-create agent
- **Output:** /opt/termlink/.tasks/active/T-2947-pickup-auditsh-d8-handover-quality-check.md
- **Context:** Initial task creation

### 2026-09-16T16:07:37Z — status-update [task-update-agent]
...
- **Scan ID:** R-c0c26b05
- **Timestamp:** 2026-09-16T16:07:54Z
- **Catalogue:** v1.3-seed
- **Overall:** PASS
- **Needs Human:** no
- **Findings:** none

### 2026-09-16T16:07:52Z — status-update [task-update-agent]
- **Change:** status: started-work → work-completed
- **Reason:** Duplicate: re-mint of our own P-073 envelope; finding completed as T-2943 and filed upstream at offset 115. Disposition in T-2953.
