...
async fn main() -> Result<()> {
    ...
    match cli.command {
        ...
        Command::Agent { action } => match action {
            ...
            AgentAction::Presence { window_secs, hub, json, filter_project, watch, watch_interval, top } => {
                commands::agent::cmd_agent_presence(window_secs, hub.as_deref(), json, filter_project.as_deref(), watch, watch_interval, top).await
            }
